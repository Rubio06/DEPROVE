    ...
    excel_file.addEventListener('change', (event) => {
        ...
        reader.onload = function(event) {
            ...
            if (sheet_data.length > 0) {
                id++;
                max = 299;
                    sql = "INSERT INTO penalidadexcel (distribuidor,nrodocumento,fechadeactivacion,linea,lineadesactivada, nombreclientealta, factorpenalidad, importepago,decripenalidad,fechapenalidad) VALUES ";
                ...
                if (sql != "INSERT INTO penalidadexcel (distribuidor,nrodocumento,fechadeactivacion,linea,lineadesactivada, nombreclientealta, factorpenalidad, importepago,decripenalidad,fechapenalidad) VALUES ") {
